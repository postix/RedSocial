...
#hombre o mujer
sexo = str(input("Para tu perfil, dime eres hombre o mujer. (Hombre/Mujer) "))
print()

#telefono
num_telefono = str(input("Para tu perfil, indícame tu número telefónico "))
print()

#telefono
pais = str(input("Para tu perfil, País de Nacimiento "))
print()
